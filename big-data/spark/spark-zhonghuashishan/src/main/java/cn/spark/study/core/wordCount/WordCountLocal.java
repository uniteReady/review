...
public class WordCountLocal {
    ...
    public static void main(String[] args) {
        ...
        SparkConf conf = new SparkConf().setMaster("local[2]").setAppName("WordCountLocal");
        ...
        String path = "F:\\tianyafu\\tianyafu_github\\review\\big-data\\spark\\spark-zhonghuashishan\\src\\main\\resources\\spark.txt";
