 ...
 * ，二是会减少内存占用空间
 */
public class UseKryoSerialize {

    public static void main(String[] args) {
        SparkConf conf = new SparkConf().setAppName("UseKryoSerialize").setMaster("local");
        //设置为使用kryo
        ...
        conf.registerKryoClasses(new Class[]{UseKryoSerialize.class});
